...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-light navbar-light fixed-top mb50">
        <!--  -->
        ...
        <div class="col-sm-6 mt-3 ml ml1">
            ...
            <ul class="navbar-nav ml-auto">
                <ul class="navbar-nav ">
                    <?php if (isset($user['name'])) { ?>
                        ...
                        <a href="?pages=giohang" class="text-bl"><span class="text-bl">Giỏ hàng</span> <span class="text-bl"><i class="fas fa-shopping-cart"></i></span>
                        <span class="badge badge-secondary badge-pill"><?php echo mysqli_num_rows($giohang); ?></span>&nbsp;&nbsp;&nbsp;</a>
                        <a href="include/logout.php" ><span class="text-bl">Đăng xuất</span> &nbsp;<span class="text-bl"><i class="fas fa-sign-out-alt" class="text-bl"></i></span></a>
