...
<body>
    ...
    <div class="jumbotron text-center" style="margin-bottom:0">
        <div class="row">
            <div class="col-sm-4">
                <a href="?pages=home" data-toggle="tooltip" title="về trang chủ!"> <img src="images/icon/logostore.png" alt=""></a>
            </div>
            <div class="col-sm-8">
    ...
    <nav class="navbar navbar-expand-lg bg-dark navbar-dark fixed-top">
        ...
        <a data-toggle="tooltip" title="Tham quan các sản phẩm của chúng tôi!" class="navbar-brand" href="?pages=product">Shop now >></a>
