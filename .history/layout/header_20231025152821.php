            ...
            <ul class="navbar-nav ml-auto">
                <ul class="navbar-nav ">
                    <?php if (isset($user['name'])) { ?>
                        <span class="text-bl"><a href="?pages=users" class="text-bl">
                            <li class="nav-item <a href="?pages=users" class="text-bl">
                            <li class="nav-item"><?= $user['name']; ?>&nbsp;&nbsp;&nbsp; </li>
                        </a>"><?= $user['name']; ?>&nbsp;&nbsp;&nbsp; </li>
                        </a></span>

                        <a href="?pages=giohang" class="text-bl"><span class="text-bl">Giỏ hàng</span> <i class="fas fa-shopping-cart"></i>
                        <span class="badge badge-secondary badge-pill"><?php echo mysqli_num_rows($giohang); ?></span>&nbsp;&nbsp;&nbsp;</a>
                        <a href="include/logout.php" ><span class="text-bl">Đăng xuất</span> &nbsp;<i class="fas fa-sign-out-alt" class="text-bl"></i></a>
