    ...
    <div class="row padding">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card text-left">
                <img height="320px" width="100%" class="img_product" src="uploads/<?php echo $value['anh_sanpham'] ?>" alt="">
...
<div class="text-center"><a data-toggle="tooltip" class="" title="Tham quan các sản phẩm của chúng tôi!"
