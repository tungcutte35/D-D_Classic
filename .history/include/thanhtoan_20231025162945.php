...
<body class="bg-light">
  ...
  <script>
    (function() {
     ...
     // Xử lý sự kiện click của radio button

document.querySelector("input[name='thanhtoan']").addEventListener("click", function() {

// Lấy giá trị của radio button được chọn

const paymentMethod = this.value;

// Hiển thị thông tin chuyển khoản ngân hàng nếu người dùng chọn phương thức thanh toán chuyển khoản qua ngân hàng
document.querySelector("#active-ck1").style.display = "none"
if (paymentMethod === "0") {
  document.querySelector("#active-ck1").style.display = "none";
}
if (paymentMethod === "1") {
  document.querySelector("#active-ck1").style.display = "block";
}
