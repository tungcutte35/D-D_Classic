        ...
        <div class="col-md-8 order-md-1">
          ...
          <form class="needs-validation" novalidate="" method="POST" action="">
            ...
            <div class="d-block my-3">
              ...
              <div class="custom-control custom-radio ck1">
                <input id="debit" name="thanhtoan thanhtoan1" value="1" type="radio" class="custom-control-input" required="">
...
document.querySelector("input[name='thanhtoan1']").addEventListener("click", function() {
