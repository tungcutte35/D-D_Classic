        ...
        <form class="needs-validation" novalidate="" method="POST" action="">
          ...
          <div class="d-block my-3">
            ...
            <div class="custom-control custom-radio">
              ...
              <div id="ck1" class="active-ck1">
                  <p>MB - 12345678900-0</p>
                  <p>MB - Chủ TK: Thanh Tung</p>
                  <p>MB - Nội dung CK: "Tên_Sanpham_Sdt</p>
...
const thanhtoan1 = this.value;

// Hiển thị thông tin tương ứng

document.querySelector("#ck1").textContent = `Bạn là ${thanhtoan1}`;
