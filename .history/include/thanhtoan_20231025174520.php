...
<body class="bg-light">
  ...
  <div class="container">
    <div class="py-5 text-center">
      ...
      <h2 class="mb50"><img src="../images/icon/pair-of-bills.png" width="40px" alt=""> Thanh toán cho đơn hàng của bạn</h2>
        ...
        <form class="needs-validation" novalidate="" method="POST" action="">
          ...
          <div class="d-block my-3">
            ...
            <div class="custom-control custom-radio">
              ...
              <label class="custom-control-label" for="debit">Chuyển khoản qua ngân hàng</label>
              <br>
              <br>
              <div id="active-ck1" style="text-align: center; padding: 10px; border: 1px solid #ccc;display: none" >
                  <p>MB - 12345678900</p>
...
// lấy radio button thanh toán ngân hàng
const bankRadio = document.querySelector("input[name='thanhtoan'][value='1']");
const bankRadio1 = document.querySelector("input[name='thanhtoan'][value='0']");
// lấy thẻ div chứa thông tin thanh toán ngân hàng
const activeCk1 = document.querySelector("#active-ck1");

// thêm event listener click vào radio button thanh toán ngân hàng
bankRadio.addEventListener("click", function() {
  // kiểm tra radio button thanh toán ngân hàng có được chọn hay không
if (bankRadio.checked) {
  // hiển thị thông tin thanh toán ngân hàng
  activeCk1.style.display = "block";
} else {
  // ẩn thông tin thanh toán ngân hàng
  activeCk1.style.display = "none";
}

// thêm event listener click vào radio button nhận hàng thanh toán
const creditRadio = document.querySelector("input[name='thanhtoan'][value='0']");
