            ...
            <div class="col-md-7 ml bdb">
                <div class="card-body-ml-auto">
                    ...
                    <form action="?pages=giohang" method="POST">
                        ...
                        &nbsp;&nbsp; Số lượng: <input class="quantity" type="number" value="1" name="quantity" class="dk1" min="1" max="<?php echo $sanpham['soluong'] ?>">
    ...
    <!--  -->
        ...
        <div class="row ne">
            <?php foreach ($img_pro as $key => $value) {   ?>
                <div class="col-sm-4">
                    <img src="uploads/<?php echo $value['anh_mota'] ?>" width="120px" alt="">
                </div>
            <?php } ?>
