  ...
  <div class="row padding">
    ...
    <div class="col-lg-9">
      <?php if (isset($_GET['keyword'])) { ?>
        <h4 class="text-center"  >Kết quả tìm kiếm cho: <?php echo $keyword ?></h4>
          ...
          <a data-toggle="tooltip" title="Chi tiết sản phẩm !" href="?pages=chitietsanpham&sanpham=<?php echo $value['id_product'] ?>">
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="card text-left">
                <img class="img_product" style="width: 100%; height: 350px" src="uploads/<?php echo $value['anh_sanpham'] ?>" alt="">
