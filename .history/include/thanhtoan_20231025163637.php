...
<body class="bg-light">
  ...
  var creditRadio = document.querySelector('label[for="credit"]');
  var debitRadio = document.querySelector('label[for="debit"]');
  var activeCk1 = document.querySelector('#active-ck1');

  // Ẩn phần tử khi trang web được tải lần đầu
  activeCk1.style.display = 'none';

  // Thêm sự kiện onchange cho radio button
  creditRadio.addEventListener('checked', function () {
    activeCk1.style.display = 'none';
  });

  debitRadio.addEventListener('checked', function () {
